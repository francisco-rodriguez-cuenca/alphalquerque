...
Author: Francisco Rodriguez Cuenca, github.com/francisco-rodriguez-cuenca
Date: Jul 26, 2022.

Based on the OthelloNNet by SourKream and Surag Nair and the TicTacToeNNet by Evgeny Tyurin.
"""
class AlquerqueNNet():
